...
#define MorseBit_PIN_INCOMING_MSG		9100
...
/*
	@TODO doc
	bool returns true if morsecode inputted was valid
*/
bool MorseBit_getMorseCode(MicroBit *uBit, MicroBitButton *btn, char *buff);
